...
It's possible that you want the two things different. For me, my site-title is **“Hux Blog”** but I want the title shows in search engine is **“凯风的博客 | Claire's Blog”** which is multi-language.
